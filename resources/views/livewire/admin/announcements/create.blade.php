<x-slot name="title">Create Announcements</x-slot>
<x-slot name="topbar">
    <x-navbar-top>
        <x-slot name="title">
            <x-breadcrumb>
            ...
            <form wire:submit.prevent="save" class="space-y-6">
                <div class="bg-white shadow-md rounded-lg p-6">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mt-2 space-y-2">
                            <label class="inline-flex items-center">
                                <input type="checkbox" wire:model.defer="selectedRoles" value=""
                    ...
                    <div class="mb-6">
                        ...
                        <x-input id="priority" wire:model.defer="priority" class="block mt-1 w-full" type="number"
                            min="0" />
                    ...
                    <div class="mb-6">
                        ...
                        <x-input id="expiredAt" wire:model.defer="expiredAt" class="block mt-1 w-full"
                            type="datetime-local" />
